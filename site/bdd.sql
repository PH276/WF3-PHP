...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 26 sep. 2017 à 16:13
...
CREATE TABLE `commande` (
  ...
  `etat` enum('en cours de traitement','envoyé','livré') DEFAULT NULL
...
CREATE TABLE `produit` (
  ...
  `public` enum('m','f','mixte') DEFAULT NULL,
...
--
ALTER TABLE `produit`
  MODIFY `id_produit` int(3) NOT NULL AUTO_INCREMENT;COMMIT;
